...
+ everything has a **will to power**
    ...
    + lets not suppress/repress/condemns it
        + removes pessimism
        + getting back meaning
+ criticism (many voices of N):
    ...
    + no psychotech to train you to overcome self-deception
    + N's tragedy: wants self-transcendence, aware of self-deception, but no machinery, method
    + satire, self-undermining, endless critique (post-modernism)
    + danger in self-transcendence without rationality
